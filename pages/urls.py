...
urlpatterns = [
    ...
    path('new-ticket/<int:duration>/<str:price>/<str:totem_id>/<str:secret_token>/<str:plate>/', views.new_ticket, name='new_ticket'),
    path('car-status/<str:plate>/', views.get_car_parking_status, name='get_car_parking_status'),
    path('pay-ticket/<int:ticket_id>/', views.pay_ticket, name='pay_ticket'),
]